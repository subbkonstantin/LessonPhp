...
<?php /*$a = 5;
$b = '05';
var_dump($a == $b); true? Потому что перменная $b интерпритируется как число 5, получем, что значения перменных равны.
var_dump((int)'012345'); 12345? Потому строка интерпретируется как число, а int приводит число к целочисленному типу.
var_dump((float)123.0 === (int)123.0); false? Потому что сравнивается значение и типа вещественного числа и целочисленного.
var_dump((int)0 === (int)'hello, world'); true? Потому что строка интрепретируется как число 0. */ ?>
